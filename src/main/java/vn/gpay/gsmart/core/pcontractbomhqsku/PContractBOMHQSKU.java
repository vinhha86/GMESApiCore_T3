...
@Table(name="pcontract_bomhq_sku")
@Entity
public class PContractBOMHQSKU implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "pcontract_bomhq_sku_generator")
	@SequenceGenerator(name="pcontract_bomhq_sku_generator", sequenceName = "pcontract_bomhq_sku_id_seq", allocationSize=1)
	private Long id;
