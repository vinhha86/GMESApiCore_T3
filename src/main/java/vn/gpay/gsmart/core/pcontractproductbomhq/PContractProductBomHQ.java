...
@Table(name = "pcontract_bomhq_product")
@Entity
public class PContractProductBomHQ implements Serializable {
	/**
	* 
	*/
	private static final long serialVersionUID = 1L;
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "pcontract_bomhq_product_generator")
	@SequenceGenerator(name = "pcontract_bomhq_product_generator", sequenceName = "pcontract_bomhq_product_id_seq", allocationSize = 1)
	private Long id;
