...
public class PContractProductBomHQ_Runnable implements Runnable {
	private Thread t;
	private final IPContract_bomHQ_npl_poline_Service po_npl_Service;
	...
	private final PContractProductBomHQ pContractProductBom;
	private final List<Long> list_colorid;
	private final List<Long> List_size;
	private final List<PContractBOMHQSKU> listbomsku;
	private final List<Map<String, String>> listdata;
	private Map<String, Long> mapsku;
	private Map<Long, String> mapcolor;
	CountDownLatch latch;

	public PContractProductBomHQ_Runnable(Long productid_link, Long pcontractid_link,
			PContractProductBomHQ pContractProductBom, List<Long> list_colorid, List<Long> List_size,
			List<PContractBOMHQSKU> listbomsku, List<Map<String, String>> listdata,
			IPContract_bomHQ_npl_poline_Service po_npl_Service, IPContract_POService pcontractPoService,
