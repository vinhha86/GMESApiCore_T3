...
@Service
public class PContract_bomHQ_npl_poline_sku_Service extends AbstractService<PContract_bomHQ_npl_poline_sku> implements IPContract_bomHQ_npl_poline_sku_Service {
	@Autowired IPContract_bomHQ_npl_poline_sku_repo repo;
	@Override
	protected JpaRepository<PContract_bomHQ_npl_poline_sku, Long> getRepository() {
		// TODO Auto-generated method stub
		return repo;
	}
	@Override
	public List<PContract_bomHQ_npl_poline_sku> getby_po_and_sku(Long orgrootid_link, Long pcontract_poid_link,
	...
	@Override
	public List<PContract_bomHQ_npl_poline_sku> getby_po(Long orgrootid_link, Long pcontract_poid_link, Long material_skuid_link, Long productid_link) {
		// TODO Auto-generated method stub
		return repo.getby_po(pcontract_poid_link, orgrootid_link, material_skuid_link, productid_link);
	}
	@Override
	public List<PContract_bomHQ_npl_poline_sku> getone_rec(Long orgrootid_link, Long pcontractid_link,
	...
	@Override
	public List<PContract_bomHQ_npl_poline_sku> getby_pcontract(Long pcontractid_link) {
