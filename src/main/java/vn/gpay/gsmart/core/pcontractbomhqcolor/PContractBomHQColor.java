...
@Table(name="pcontract_bomhq_color")
@Entity
public class PContractBomHQColor implements Serializable{/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "pcontract_bomhq_color_generator")
	@SequenceGenerator(name="pcontract_bomhq_color_generator", sequenceName = "pcontract_bomhq_color_id_seq", allocationSize=1)
	private Long id;
