...
public class SKUBalance_Data implements Serializable {
	...
	private String mat_sku_ls_pos;
	private String mat_sku_ls_prodcolors;
	...
	public String getMat_sku_ls_pos() {
		return mat_sku_ls_pos;
	}
	public void setMat_sku_ls_pos(String mat_sku_ls_pos) {
		this.mat_sku_ls_pos = mat_sku_ls_pos;
	}
	public String getMat_sku_ls_prodcolors() {
		return mat_sku_ls_prodcolors;
	}
	public void setMat_sku_ls_prodcolors(String mat_sku_ls_prodcolors) {
		this.mat_sku_ls_prodcolors = mat_sku_ls_prodcolors;
	}
